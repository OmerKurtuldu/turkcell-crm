...
class VFNSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class VFNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VFNDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new VFNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VFNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VFNDateTimeConverter dateTimeConverter = new VFNStandardDateTimeConverter();

    public VFNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VFNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VFNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VFNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VFNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VFNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
