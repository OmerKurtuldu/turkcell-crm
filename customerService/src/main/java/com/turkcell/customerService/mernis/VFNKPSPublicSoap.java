...
public class VFNKPSPublicSoap
{
    ...
    public VFNKPSPublicSoap(){}

    public VFNKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VFNKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VFNExtendedSoapSerializationEnvelope envelope= new VFNExtendedSoapSerializationEnvelope(VFNExtendedSoapSerializationEnvelope.VER11);
